...
class SimpleNivoSliderAdmin {
	 ...
	 -->
	  ...
	  <div id="simplenivoslider-admin-tabs-1">
		<div class="wrap">
			...
			<div style="float:left;"><?php _e('Number of items per page:'); ?><input type="text" name="simplenivoslider_mgsettings_pagemax" value="<?php echo $pagemax; ?>" size="3" /></div>
	  ...
	  <div id="simplenivoslider-admin-tabs-3">
		<div class="wrap">
			...
			<li><h3><?php _e('Meta-box of Simple NivoSlider will be added to [Edit Post] and [Edit Page]. Please do apply it.', 'simple-nivoslider'); ?></h3></li>
	...
	function pagenation($page, $pagebegin, $pageend, $pagelast, $scriptname){
		...
		?>
		<div class="simple-nivoslider-pages">
		<span class="simple-nivoslider-links">
		<?php
		if ( $page <> 1 ){
			?><a title='<?php _e('Go to the first page', 'simple-nivoslider'); ?>' href='<?php echo $scriptnamefirst; ?>'>&laquo;</a>
			<a title='<?php _e('Go to the previous page', 'simple-nivoslider'); ?>' href='<?php echo $scriptnameprev; ?>'>&lsaquo;</a>
		<?php
		}
		...
		<?php
		if ( $page <> $pagelast ){
			?><a title='<?php _e('Go to the next page', 'simple-nivoslider'); ?>' href='<?php echo $scriptnamenext; ?>'>&rsaquo;</a>
			<a title='<?php _e('Go to the last page', 'simple-nivoslider'); ?>' href='<?php echo $scriptnamelast; ?>'>&raquo;</a>
		<?php
		}
		?>
		</span>
